...
class IMAGE_PROM :
    ...
    def create_background_prom(self, ptask) :
        ...
        return response['background'], response['character_action'], response['background_character']
    ...
    def create_prom(self, ptask) :
        ...
        background_prom, action_prom, background_character = self.create_background_prom(ptask)

        # background info
        description = (
            f"charactor:{age} years old child"
            f"backgound : {background_prom},"
            f"background_character:{background_character},"
            f"charactor_action : {action_prom},"
            f"wearing : {clothing},"
